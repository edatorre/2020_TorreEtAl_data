...
baselineData = as_tibble(read.csv("01_rawData/180611_ColonyGrowth22_WM989-5a3_ScreenFollowUp_18KOs_reanalysis/summarizedResults/baseline_well7-12_plateSummary.csv"))
baselineData = baselineData[,1:2]
colnames(baselineData) = c("well", "cellNumber_baseline")

#Read in colony growth data
colonyGrowthData = as_tibble(read.csv("01_rawData/180611_ColonyGrowth22_WM989-5a3_ScreenFollowUp_18KOs_reanalysis/summarizedResults/onDrug_well7-12_plateSummary.csv"))
...
#save output table
write.table(mergedData, file ="03_extractedData/180611_ColonyGrowth22_WM989-5a3_ScreenFollowUp_18KOs_reanalysis/plate2_extractedData.txt", row.names = FALSE, col.names = TRUE, sep = "\t", quote = FALSE)

...
listOfDatabases = list.dirs(path = "03_extractedData/190408_RNAseq_otherSamples/NGFRandEGFRhi/GSEA/GSEAoutput/",
...
for (database in listOfDatabases) {
  ...
  database.ES.path = paste("03_extractedData/190408_RNAseq_otherSamples/NGFRandEGFRhi/GSEA/GSEAoutput/", 
                           database, "/", sep = "")
  ...
  #save file
  path.to.combined.ES = paste("03_extractedData/190408_RNAseq_otherSamples/NGFRandEGFRhi/GSEA/ESfiles/", database,

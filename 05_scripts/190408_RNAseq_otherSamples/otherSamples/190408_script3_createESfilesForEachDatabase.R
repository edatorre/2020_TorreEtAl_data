...
listOfDatabases = list.dirs(path = "03_extractedData/190408_RNAseq_otherSamples/otherDatatsets/GSEA/GSEAoutput/",
                            recursive = FALSE, full.names = FALSE)

#Set the path to the database gene sets
database.genesets = "02_metadata/190408_RNAseq_otherSamples/GSEAgeneSets/"
...
for (database in listOfDatabases) {
  ...
  database.ES.path = paste("03_extractedData/190408_RNAseq_otherSamples/otherDatatsets/GSEA/GSEAoutput/", 
                           database, "/", sep = "")
  ...
  #save file
  path.to.combined.ES = paste("03_extractedData/190408_RNAseq_otherSamples/otherDatatsets/GSEA/ESfiles/", database,
